            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select name="pid">
                                ...
                                @foreach($data as $v)
                                    <option value="{{$v->menu_id}}">{{$v->_menu_name}}</option>
                                @endforeach
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" class="sm" name="menu_name">
                        </td>
                    </tr>
                    <tr>
                        <th><i class="require">*</i>图标：</th>
                        <td>
                            <input type="text" name="icon" class="lg" >
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th>排序：</th>
                        <td>
                            <input type="text" name="menu_order" class="sm" value="0">
                        </td>
                    </tr>
