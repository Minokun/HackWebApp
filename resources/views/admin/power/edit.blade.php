...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="#">首页</a> &raquo; <a href="#">用户管理</a> &raquo; 权限组修改
    </div>
    <!--面包屑导航 结束-->
    ...
    <!--结果集标题与导航组件 结束-->
    <div class="result_wrap">
        <form action="{{url('admin/power/'.$file->role_id)}}" method="post"  class="layui-form">
            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text" class="sm" name="role_name" value="{{$file->role_name}}">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td  >
                            <input type="checkbox" name="enable" @if($file->enable==1) checked value="1" @endif  lay-skin="switch" lay-text="开启|关闭">
                        </td>
                    </tr>
                    <tr>
                        <th></th>
