...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('admin/user')}}" method="post"  class="layui-form">
            {{csrf_field()}}
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text" class="sm" name="user_name">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="sm" name="root_name">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td  >
                            <input type="checkbox" name="status" checked value="1" lay-skin="switch" lay-text="开启|关闭">
                        </td>
                    </tr>
                    <tr>
                        <th></th>
